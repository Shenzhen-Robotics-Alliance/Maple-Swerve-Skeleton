...
public class RobotContainer {
    ...
    public RobotContainer() {
        ...
        this.exampleShooterOptimization =
    ...
    private LoggedDashboardChooser<Auto> buildAutoChooser() {
        ...
        autoSendableChooser.addOption(
                "Example Pathplanner Auto", new PathPlannerAutoWrapper("Example Auto"));
    ...
    public void configureButtonBindings() {
        ...
        final JoystickDriveAndAimAtTarget exampleFaceTargetWhileDriving =
        ...
        final AutoAlignment exampleAutoAlignment =
                new AutoAlignment(
                        drive,
                        /* (position of AMP) */
                        () ->
