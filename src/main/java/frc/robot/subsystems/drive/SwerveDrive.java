...
public class SwerveDrive extends MapleSubsystem implements HolonomicDriveSubsystem {
    ...
    public static final ChassisHeadingController swerveHeadingController =
    ...
    public void periodic(double dt, boolean enabled) {
        ...
        Logger.recordOutput(
                ...
                (MapleTimeUtils.getRealTimeSeconds() - t0) * 1000);
        ...
        final double timeNotVisionResultSeconds =
                MapleTimeUtils.getLogTimeSeconds() - previousMeasurementTimeStamp;
    ...
    public void addVisionMeasurement(
        ...
        poseEstimator.addVisionMeasurement(
                poseEstimationResult.pointEstimation,
                timestamp,
                poseEstimationResult.getEstimationStandardError());
    }
    ...
    private void startDashboardDisplay() {
        SmartDashboard.putData(
                ...
                builder -> {
                    ...
                    builder.addDoubleProperty(
                            "Robot Angle",
                            () -> getFacing().minus(FieldConstants.getDriverStationFacing()).getRadians(),
                            null);
                });
    }
}
