...
public class MaplePathPlannerLoader {
    ...
    private static PathPlannerPath pathReversedFromJson(
            JSONObject pathJson, PathConstraints globalConstraints, GoalEndState goalEndState) {
    ...
    private static <E> List<E> revereList(List<E> originalList) {
        ...
        for (int i = originalList.size() - 1; i >= 0; i--) reversedList.add(originalList.get(i));
        return reversedList;
    }
    ...
    /**
     * Original Source {@link com.pathplanner.lib.path.GoalEndState} Create a goal end state from json
     *
    ...
    private static ConstraintsZone constraintsZoneFromJson(JSONObject zoneJson) {
        ...
        PathConstraints constraints = pathConstraintsFromJson((JSONObject) zoneJson.get("constraints"));
    ...
    /**
     * Original Source {@link com.pathplanner.lib.path.EventMarker} Create an event marker from json
     *
