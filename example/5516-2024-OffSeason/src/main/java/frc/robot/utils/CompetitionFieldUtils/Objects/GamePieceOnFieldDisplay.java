...
/**
 * displays a game piece on field to Advantage Scope since game pieces MUST be displayed as 3d objects in Advantage
 * Scope we have to convert the 2d pose of the game piece to a 3d pose
 */
public interface GamePieceOnFieldDisplay extends CompetitionFieldVisualizer.Object2dOnFieldDisplay {
    ...
    default Pose3d getPose3d() {
        ...
        final Translation3d translation3d = new Translation3d(pose2d.getX(), pose2d.getY(), getGamePieceHeight() / 2);
