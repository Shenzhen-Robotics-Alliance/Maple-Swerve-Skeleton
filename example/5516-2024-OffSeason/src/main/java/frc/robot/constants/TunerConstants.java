...
public class TunerConstants {
    ...
    public static final double kFrontLeftEncoderOffset = 0.303955078125;
    public static final boolean kFrontLeftSteerInvert = true;

    public static final double kFrontLeftXPosInches = 9.25197;
    public static final double kFrontLeftYPosInches = 11.614175;

    // Front Right
    public static final int kFrontRightDriveMotorId = 3;
    public static final int kFrontRightSteerMotorId = 4;
    public static final int kFrontRightEncoderId = 2;
    public static final double kFrontRightEncoderOffset = -0.230224609375;
    public static final boolean kFrontRightSteerInvert = true;

    public static final double kFrontRightXPosInches = 9.25197;
    public static final double kFrontRightYPosInches = -11.614175;

    // Back Left
    public static final int kBackLeftDriveMotorId = 5;
    public static final int kBackLeftSteerMotorId = 6;
    public static final int kBackLeftEncoderId = 3;
    public static final double kBackLeftEncoderOffset = -0.218017578125;
    public static final boolean kBackLeftSteerInvert = true;

    public static final double kBackLeftXPosInches = -9.25197;
    public static final double kBackLeftYPosInches = 11.614175;

    // Back Right
    public static final int kBackRightDriveMotorId = 7;
    public static final int kBackRightSteerMotorId = 8;
    public static final int kBackRightEncoderId = 4;
    public static final double kBackRightEncoderOffset = -0.071533203125;
    public static final boolean kBackRightSteerInvert = true;

    public static final double kBackRightXPosInches = -9.25197;
    public static final double kBackRightYPosInches = -11.614175;
