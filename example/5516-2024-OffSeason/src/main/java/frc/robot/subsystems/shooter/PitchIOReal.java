...
public class PitchIOReal implements PitchIO {
    ...
    private final StatusSignal<Double> pitchMotor1SuppliedAmps,
            pitchMotor2SuppliedAmps,
            pitchRelativeEncoderPositionRev,
            pitchEncoderVelocityRevPerSec;
