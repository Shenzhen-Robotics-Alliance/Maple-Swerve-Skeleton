...
public class ScoreAmp extends Command {
    ...
    public Command withVisualization(
        ...
        final Command visualizeAmpNote =
                Commands.runOnce(
                        () -> {
                            final Transform2d poseError =
                                    FieldConstants.toCurrentAlliancePose(CORRECT_SCORE_AMP_ROBOT_POSE_BLUE)
                                            .minus(driveSubsystem.getPose());
                            final Translation2d shooterPositionOnField =
                                    driveSubsystem
                                            .getPose()
                                            .getTranslation()
    ...
    private static final double SHOOTER_HEIGHT_AMP = 0.4,
    ...
    private static final Pose2d CORRECT_SCORE_AMP_ROBOT_POSE_BLUE =
            new Pose2d(1.81, 7.71, Rotation2d.fromDegrees(-90));
    ...
    private static final class AmpFailedNote extends GamePieceOnFlyDisplay {
        ...
        public AmpFailedNote(
            ...
            super(
                    new Translation3d(
                            shooterPositionOnField.getX(), shooterPositionOnField.getY(), SHOOTER_HEIGHT_AMP),
            ...
            if (simulation != null)
                CommandScheduler.getInstance()
                        .schedule(
                                Commands.waitSeconds(AMP_FLIGHT_TIME_SECONDS)
                                        .andThen(
                                                Commands.runOnce(
                                                        () ->
                                                                simulation.addGamePiece(
                                                                        new Crescendo2024FieldObjects.NoteOnFieldSimulated(
